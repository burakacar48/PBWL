...
"""
Baccarat P/B Pattern Analiz Uygulaması - Modern UI
...
class ModernButton(QPushButton):
    ...
    def __init__(self, text="", parent=None, icon_text="", start_color="#3a4c5d", end_color="#2a3340"):
    ...
    def update_stats(self, model_stats, predictions=None):
        ...
        for i, (model_name, stats) in enumerate(sorted_stats):
            ...
            if total >= 3:  # Sadece yeterli tahmin varsa renklendirme yap
                if success_rate >= 70:
                    success_item.setForeground(QColor("#6eb7e7"))  # Yeşil
            ...
            if prediction == 1:
                pred_text = "P"
                pred_color = QColor("#6eb7e7")  # Yeşil
            elif prediction == 2:
                pred_text = "B"
...
class WLPatternAnalyzer(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("Baccarat Pattern Analyzer")
    ...
    def _set_dark_theme(self):
        ...
        palette.setColor(QPalette.Link, QColor("#6eb7e7"))
        palette.setColor(QPalette.Highlight, QColor("#6eb7e7"))
        ...
        self.setStyleSheet("""
            ...
            QComboBox QAbstractItemView {
                background-color: #3d3d54;
                color: white;
                selection-background-color: #6eb7e7;
    ...
    def _setup_ui(self):
        ...
        # Başlık metni
        title_label = QLabel("Baccarat Pattern Analyzer")
        ...
        # W butonu
        self.win_button = ModernButton("P", self, "✓", "#3a4c5d", "#2a3340")
        ...
        # L butonu
        self.loss_button = ModernButton("B", self, "✗", "#5d3a4a", "#3d2a33")
        ...
        self.confidence_label.setStyleSheet("font-size: 24px; font-weight: bold; color: #6eb7e7; min-width: 80px;")
    ...
    def _update_matrix_status(self):
        ...
        if required > 0:
            ...
            self.matrix_status_value.setStyleSheet("color: #6eb7e7; font-size: 14px;")
    ...
    def _perform_analysis(self):
        ...
        if result == 1:  # P (Player)
            self.prediction_indicator.setStyleSheet("QFrame { background-color: #6eb7e7; border-radius: 25px; }")
            self.prediction_text.setText("P")
            self.prediction_text.setStyleSheet("QLabel { color: #1a1a2e; font-weight: bold; font-size: 24px; }")
            self.confidence_fill.setStyleSheet("background-color: #6eb7e7; border-radius: 3px;")
            self.confidence_label.setStyleSheet("font-size: 24px; font-weight: bold; color: #6eb7e7; min-width: 80px;")
        elif result == 2:  # B (Banker)
            self.prediction_indicator.setStyleSheet("QFrame { background-color: #fda4af; border-radius: 25px; }")
            self.prediction_text.setText("B")
            self.prediction_text.setStyleSheet("QLabel { color: #1a1a2e; font-weight: bold; font-size: 24px; }")
